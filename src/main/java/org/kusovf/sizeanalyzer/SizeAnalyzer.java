...
public class SizeAnalyzer {
    ...
    private void collectStats(File inFile, EntityAnalyzeResult parent) {
    ...
    private EntityAnalyzeResult buildEntityTree(EntityMeta meta, EntityAnalyzeResult parent) {
